    ...
    class MDIntegrator : public SystemAccess {
      public:
        ...
        */
        ...
        boost::signals2::signal0 <void> aftCalcSlow; // after calculation of slow forces updateForces(true) in VerlocityVerletRESPA
        ...
        boost::signals2::signal0 <void> aftIntSlow; // after integrateSlow() in VerlocityVerletRESPA
