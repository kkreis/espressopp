...
namespace espressopp {
  ...
  namespace integrator {
    ...
    LOG4ESPP_LOGGER(VelocityVerletRESPA::theLogger, "VelocityVerletRESPA");
    ...
    {
      LOG4ESPP_INFO(theLogger, "free VelocityVerletRESPA");
    }
    ...
    void VelocityVerletRESPA::resetTimers() {
      timeForce  = 0.0;
      for(int i = 0; i < 100; i++)
        timeForceComp[i] = 0.0;
      timeComm1  = 0.0;
    ...
    static object wrapGetTimers(class VelocityVerletRESPA* obj) {
      real tms[10];
      obj->loadTimers(tms);
    ...
    void VelocityVerletRESPA::loadTimers(real t[10]) {
      t[0] = timeRun;
      t[1] = timeForceComp[0];
      t[2] = timeForceComp[1];
      t[3] = timeForceComp[2];
    ...
    void VelocityVerletRESPA::printTimers() {
    ...
    void VelocityVerletRESPA::printForces(bool withGhosts)
    {
    ...
    void VelocityVerletRESPA::printPositions(bool withGhosts)
    {
