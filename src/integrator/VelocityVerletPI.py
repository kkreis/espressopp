...
if pmi.isController :
    class VelocityVerletPI(MDIntegrator):
        ...
        pmiproxydefs = dict(
          ...
          pmiproperty = [ 'sStep', 'mStep', 'ntrotter', 'gamma', 'CMDparameter', 'PILElambda', 'temperature', 'clmassmultiplier', 'speedup', 'KTI', 'constkinmass', 'verletList', 'centroidthermostat', 'PILE', 'realkinmass', 'verletlistBuilds' ],
          ...
          pmiinvoke = ['getTimeStep', 'getTimers', 'getmStep', 'getsStep', 'getNtrotter', 'getTemperature', 'getGamma', 'getCMDparameter', 'getPILElambda', 'getClmassmultiplier', 'getSpeedup', 'getKTI', 'getPILE', 'getRealKinMass', 'getCentroidThermostat', 'getConstKinMass', 'getVerletList', 'getVerletlistBuilds' ]
        )
