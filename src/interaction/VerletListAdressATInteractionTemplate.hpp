...
namespace espressopp {
  namespace interaction {
    ...
    VerletListAdressATInteractionTemplate < _Potential >::
    addForces() {
    ...
    VerletListAdressATInteractionTemplate < _Potential >::
    computeEnergyDeriv() {
      std::cout << "Warning! At the moment computeEnergyDeriv in VerletListAdressATInteractionTemplate does not work." << std::endl;
      return 0.0;
    }
    ...
    VerletListAdressATInteractionTemplate < _Potential >::
    computeEnergyAA() {
      std::cout << "Warning! At the moment computeEnergyAA in VerletListAdressATInteractionTemplate does not work." << std::endl;
      return 0.0;
    }
    ...
    VerletListAdressATInteractionTemplate < _Potential >::
    computeEnergyCG() {
      std::cout << "Warning! At the moment computeEnergyCG in VerletListAdressATInteractionTemplate does not work." << std::endl;
      return 0.0;
    }
    ...
    computeVirialX(std::vector<real> &p_xx_total, int bins) {
      std::cout << "Warning! At the moment computeVirialX in VerletListAdressATInteractionTemplate does'n work"<<std::endl;
    }
    ...
    computeVirial() {
      ...
      std::cout << "Warning! At the moment computeVirial in VerletListAdressATInteractionTemplate does not work." << std::endl;
      return 0.0;
    }
    ...
    computeVirialTensor(Tensor& w) {
      ...
      std::cout << "Warning! At the moment computeVirialTensor in VerletListAdressATInteractionTemplate does'n work"<<std::endl;
    }
