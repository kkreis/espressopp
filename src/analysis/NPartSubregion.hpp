...
namespace espressopp {
  namespace analysis {
    ...
    public:
      NPartSubregion(shared_ptr< System > system, int parttype, real span, int geometry) : Observable(system), parttype(parttype), span(span), geometry(geometry) {result_type=real_scalar;}
